...
class  Roombooking:
    def __init__(self,root):
        ...
        # ==============labelFrame===========
        labelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="Room booking Details",font=("time new roman",12,"bold"),padx=2,)
        ...
        # Paid text
        lblPaidText=Label(labelframeleft,font=("arial",12,"bold"),text="Paid Text:",padx=2,pady=6)
        lblPaidText.grid(row=7,column=0,sticky=W)
        txtPaidText=ttk.Entry(labelframeleft,textvariable=self.var_paidtax,font=("arial",13,"bold"),width=29)
        txtPaidText.grid(row=7,column=1)
        ...
        # ===========room img =============
        img3=Image.open(r"C:\Users\Shahroz\Desktop\Hotel_Managment_system\pics for hotel man\bed pic 4.jpg")
        img3=img3.resize((470,300),Resampling.LANCZOS) 
        self.photoimg3=ImageTk.PhotoImage(img3) 
        lblimg=Label(self.root,image=self.photoimg3,bd=0,relief=RIDGE)
        lblimg.place(x=630,y=55,width=470,height=300)
        ...
        detail_table.place(x=0,y=50,width=690,height=165)

        scroll_x=ttk.Scrollbar(detail_table,orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(detail_table,orient=VERTICAL)

        self.room_table=ttk.Treeview(detail_table,column=("contact","checkin","checkout","roomtype","roomavailable","meal",
       ...
       if self.var_contact.get()=="": 
         messagebox.showerror("Error","Please enter contact number",parent=self.root)
          ...
          if row==None:
             ...
             showDataframe.place(x=430,y=55,width=195,height=195)
    ...
    def total(self):
     ...
     self.var_noofdays.set(no_of_days)  # Set this in your Tkinter variable

     if self.var_meal.get() == "launch" and self.var_roomtype.get() == "Laxury":
         meal_cost = 300
         room_cost = 4000
         total_per_day = meal_cost + room_cost
         total_cost = no_of_days * total_per_day
         tax = total_cost * 0.09

         self.var_paidtax.set("Rs. {:.2f}".format(tax))
         self.var_actualtotal.set("Rs. {:.2f}".format(total_cost))
         self.var_total.set("Rs. {:.2f}".format(total_cost + tax))
